...
const SNBMCharTable SNBMString::BMCharTable[] =
{
	{L'　', 0, 0, 0, 0},
	{ L'！', 0, 0, 16, 0 },
	{ L'”', 0, 0, 32, 0 },
...
// Char→BMChar変換
BMChar SNBMString::CharToBMChar(Char ch)
{
...
// String→BMString
Void SNBMString::StringToBMString(String str, Int32 len, BMString bmstr, Int32 bmlen)
{
	Int32 cnt;
...
// BMChar→Char変換
Char SNBMString::BMCharToChar(BMChar bmch)
{
	return BMCharTable[bmch].Character;
}

// BMString→String変換
Void SNBMString::BMStringToString(BMString bmstr, Int32 bmlen, String str, Int32 len)
{
	Int32 cnt;
	Int32 cnv_len = (Int32)SNMath::SelectMin(len, bmlen);
...
// ビットマップフォント座標取得
SNPoint SNBMString::GetBMCharPoint(BMChar bmch)
{
...
Void SNBMString::SetString(String str)
{
	...
	// StringからBMStringへ変換
	StringToBMString(str, str_len, bmstr, str_len);
...
Void SNBMString::Print(String format, Int64 value)
{
	...
	// StringからBMStringへ変換
	StringToBMString(cnv_str, need_len, (BMString)StringBuffer.GetAddress(), need_len);
