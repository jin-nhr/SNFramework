...
const SNUserConfiguration SNConfiguration::UserConfigurationInititalValue =
{
	...
	// 入力マッピング
	{
		...
		SNKeyCodeA,// メニュー(Xボタン)
		SNKeyCodeS,// アクション(Yボタン)
		SNKeyCodeC,// スタート
		SNKeyCodeV,// セレクト
		SNKeyCodeQ,// ページ戻し(Lボタン)
		SNKeyCodeW,// ページ送り(Rボタン)
		SNKeyCodePageUp,// リストアップ(拡大)
		SNKeyCodePageDown,// リストダウン(縮小)

		// マウスボタン
		SNMouseButtonNull,// 方向キー上
		SNMouseButtonNull,// 方向キー下
		SNMouseButtonNull,// 方向キー左
		SNMouseButtonNull,// 方向キー右
		SNMouseButtonNull,// 決定(Aボタン)
		SNMouseButtonNull,// キャンセル(Bボタン)
		SNMouseButtonNull,// メニュー(Xボタン)
		SNMouseButtonNull,// アクション(Yボタン)
		SNMouseButtonNull,// スタート
		SNMouseButtonNull,// セレクト
		SNMouseButtonNull,// ページ戻し(Lボタン)
		SNMouseButtonNull,// ページ送り(Rボタン)
		SNMouseButtonNull,// リストアップ(拡大)
		SNMouseButtonNull,// リストダウン(縮小)
